...
<input type="button" value= "탈 퇴" 
 ...
 <h6> <a href="/WebPractice/member/dbConnectionMember.jsp"> 회원(Member) 목록 확인 </a></h6>
      <br /> <br />
      
 <input type="button" value= "게시판"  onclick="window.location='/WebPractice/board/Mlist.jsp'"/>  
